...
export function Products(){
    ...
    <div className="row pb-5 mb-4">
      ...
      <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
        {/* Card*/}
        <div id="marginbottomofcard" className="card rounded shadow-sm border-0">
          <div className="card-body p-4">
            ...
            Cloud White / Chalk White / Zero Metalic <p className="costindollors">82$</p>
            </p>
      ...
      <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <div className="card rounded shadow-sm border-0">
          <div className="card-body p-4">
            <img
              src="https://bootstrapious.com/i/snippets/sn-cards/shoes-2_g4qame.jpg"
              alt=""
              className="img-fluid d-block mx-auto mb-3"
            />
            <h5>
            ...
            <p className="small text-muted font-italic">
            Grey Two / Collegiate Green / Cloud White <p className="costindollors">78$</p>
            </p>
            <ul className="list-inline small">
              <li className="list-inline-item m-0">
                <i className="fa fa-star text-success" />
      ...
      <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <div className="card rounded shadow-sm border-0">
          <div className="card-body p-4">
            <img
              src="https://bootstrapious.com/i/snippets/sn-cards/shoes-3_rk25rt.jpg"
              alt=""
              className="img-fluid d-block mx-auto mb-3"
            />
            <h5>
            ...
            <p className="small text-muted font-italic">
            Shadow Brown / Preloved Brown / Cloud White  <p className="costindollors">46$</p></p>
            <ul className="list-inline small">
              <li className="list-inline-item m-0">
                <i className="fa fa-star text-success" />
              </li>
      ...
      <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <div className="card rounded shadow-sm border-0">
          <div className="card-body p-4">
            <img
              src="https://bootstrapious.com/i/snippets/sn-cards/shoes-4_vgfjy9.jpg"
              alt=""
              className="img-fluid d-block mx-auto mb-3"
            />
            <h5>
            ...
            <p className="small text-muted font-italic">
            Core Black / Screaming Orange / Shadow Olive <p className="costindollors">90$</p>
            </p>
            <ul className="list-inline small">
              <li className="list-inline-item m-0">
                <i className="fa fa-star text-success" />
